...
<body>
    <div class="container">
        <%@ include file="bar/categories_bar.jsp"%>
        	<div class="row clearfix" style="margin">
        		<div class="col-xs-12 column " id="search">
        			<form action="${webroot}/GoodController/goodSearchController" method="post">
            ...
            <div class="row clearfix" style="margin-bottom: 60px;margin-top: 20px;text-align: center;">
                ...
                <div class="col-xs-12 column">
                    <div class="btn-group btn-group-md">
                        <button class="btn btn-default" type="button" onclick="{location.href='goodsWithClassificationController?pageNo=${page.topPageNo}&classificationId=${classificationId}'}">
                            <em class="glyphicon glyphicon-align-justify"></em> 首页
                        </button>
                        <c:choose>
                            <c:when test="${page.pageNo!=1}">
                                <button class="btn btn-default" type="button" onclick="{location.href='goodsWithClassificationController?pageNo=${page.previousPageNo}&classificationId=${classificationId}'}">
                        ...
                        <c:choose>
                            <c:when test="${page.pageNo != page.totalPages}">
                                <button class="btn btn-default" type="button" onclick="{location.href='goodsWithClassificationController?pageNo=${page.nextPageNo}&classificationId=${classificationId}'}">
                        ...
                        <button class="btn btn-default" type="button" onclick="{location.href='goodsWithClassificationController?pageNo=${page.bottomPageNo}&classificationId=${classificationId}'}">
